package org.embulk.output.poi_excel;
...
public class PoiExcelFileOutputPlugin
        implements FileOutputPlugin
{
    ...
    public ConfigDiff resume(TaskSource taskSource,
            ...
            FileOutputPlugin.Control control)
    {
        throw new UnsupportedOperationException("poi_excel output plugin does not support resuming");
    }
    ...
    public TransactionalFileOutput open(TaskSource taskSource, final int taskIndex)
    {
        ...
        throw new UnsupportedOperationException("PoiExcelFileOutputPlugin.open method is not implemented yet");
